...
def main():'''
Hanzi-Coverter created by Kevin Leung (https://github.com/kevinwleung/)

hanzi-converted.py - A simple Python program that converts Chinese characters to Mandarin, Cantonese, Hangeul (Korean) and Vietnamese and Japanese (Onyomi + Kunyomi) readings using data from Unihan. Open with Python 3.6.
